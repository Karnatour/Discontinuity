...
@Mod(modid = "discontinuity", name = "Discontinuity", version = "0.1.0")
public class ContinuityClient {
	public static final String ID = "discontinuity";
	public static final String NAME = "Discontinuity";
	...
	@Mod.Instance
	public static ContinuityClient instance;

	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		File configFile = new File(event.getModConfigurationDirectory(), ID + ".json");
		ContinuityConfig.INSTANCE = new ContinuityConfig(configFile);
