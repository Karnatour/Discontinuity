...
public class ResourceRedirectHandler {
	...
	@Nullable
	public static ResourceRedirectHandler get(IResourceManager resourceManager) {
		if (resourceManager instanceof SimpleReloadableResourceManager) {
			return ((ISimpleReloadableResourceManager) resourceManager).discontinuity$getRedirectHandler();
		}
		return null;
	}
	@Nullable
	public static ResourceRedirectHandler get() {
		return get(Minecraft.getMinecraft().getResourceManager());
	}
	...
	public ResourceLocation redirect(ResourceLocation id) {
		...
		ResourceLocation newId = new ResourceLocation(id.getNamespace(), newPath);
