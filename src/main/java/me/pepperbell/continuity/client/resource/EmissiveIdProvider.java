...
public final class EmissiveIdProvider {
	...
	@Nullable
	public static ResourceLocation toEmissiveId(ResourceLocation spriteId, String emissiveSuffix) {
	...
	@Nullable
	private static ResourceLocation toEmissiveIdStandard(ResourceLocation spriteId, String emissiveSuffix) {
		String path = spriteId.getPath();
		if (!path.endsWith(emissiveSuffix)) {
			return new ResourceLocation(spriteId.getNamespace(), path + emissiveSuffix);
		}
		return null;
	}
	 ...
	 */
	@Nullable
	private static ResourceLocation toEmissiveIdCITR(ResourceLocation spriteId, String emissiveSuffix) {
		String path = spriteId.getPath();
		...
		if (!path.endsWith(emissiveSuffix)) {
			...
			return new ResourceLocation(spriteId.getNamespace(), emissivePath);
		}
		return null;
	}
	...
	private interface Provider {
		@Nullable
		ResourceLocation toEmissiveId(ResourceLocation spriteId, String emissiveSuffix);
	}
}
